...
#define NODE_MAIN_LOGGER_NAME "small_gicp_relocalization_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libsmall_gicp_relocalization.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<small_gicp_relocalization::SmallGicpRelocalizationNode>";
