...
#define NODE_MAIN_LOGGER_NAME "terrain_analysis_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libterrain_analysis.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<terrain_analysis::TerrainAnalysisNode>";
